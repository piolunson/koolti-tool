...
MENU_DATA = [
    (1,  "IP Tracker",                'NET', False),
    (2,  "DNS Lookup",                'NET', False),
    (3,  "Port Scanner",              'NET', False),
    (4,  "MAC Lookup",                'NET', False),
    (5,  "Local Network Info",        'NET', False),
    (6,  "Ping Tool",                 'NET', False),
    (7,  "Subdomain Finder",          'NET', False),
    (8,  "Traceroute",                'NET', False),
    (9,  "Reverse IP Lookup",         'NET', False),
    (10, "GeoIP Info",                'NET', False),
    (11, "Network Interface Stats",   'NET', False),
    (12, "ARP Scanner",               'NET', False),
    (13, "Banner Grabber",            'NET', False),
    (14, "HTTP Method Tester",        'NET', False),
    (15, "SMTP Checker",              'NET', False),
    (16, "FTP Checker",               'NET', False),
    (17, "SSH Checker",               'NET', False),
    (18, "SNMP Checker",              'NET', False),
    (19, "BGP ASN Lookup",            'NET', False),
    (20, "IP Range Scanner",          'NET', False),
    (21, "Network Speed Test",        'NET', False),
    (22, "WiFi SSID Scanner",         'NET', False),
    (23, "mDNS Discovery",            'NET', False),
    (24, "DNS Zone Transfer",         'NET', False),
    (25, "Open Redirect Tester",      'NET', False),
    (26, "CORS Policy Checker",       'NET', False),
    (27, "CDN Detector",              'NET', False),
    (28, "IPv6 Checker",              'NET', False),
    (29, "Port Knock Detector",       'NET', True),
    (30, "Shodan IP Lookup",          'NET', False),
    (31, "Admin Finder",              'WEB', False),
    (32, "CMS Detector",              'WEB', False),
    (33, "WAF Detector",              'WEB', False),
    (34, "HTTP Header Inspector",     'WEB', False),
    (35, "Link Extractor",            'WEB', False),
    (36, "WHOIS Lookup",              'WEB', False),
    (37, "Robots.txt Checker",        'WEB', False),
    (38, "URL Scanner",               'WEB', False),
    (39, "Email Validator",           'WEB', False),
    (40, "Wayback Machine Check",     'WEB', False),
    (41, "Tech Stack Detector",       'WEB', False),
    (42, "Broken Link Checker",       'WEB', False),
    (43, "SSL Certificate Info",      'WEB', False),
    (44, "HTTP Status Bulk Checker",  'WEB', False),
    (45, "Google Dork Generator",     'WEB', False),
    (46, "HTTP Parameter Fuzzer",     'WEB', True),
    (47, "JS File Extractor",         'WEB', True),
    (48, "Form Extractor",            'WEB', True),
    (49, "Cookie Inspector",          'WEB', True),
    (50, "IP Reputation Check",       'WEB', True),
    (51, "Path Traversal Tester",     'WEB', True),
    (52, "SQL Error Detector",        'WEB', True),
    (53, "Subdomain Takeover Check",  'WEB', True),
    (54, "TLS Version Checker",       'WEB', True),
    (55, "WhatWeb Lite",              'WEB', True),
    (56, "Latency Map",               'NET', True),
    (57, "Certificate Transparency",  'WEB', True),
    (58, "HTTP Cache Inspector",      'WEB', True),
    (59, "Security Headers Score",    'WEB', True),
    (60, "DNS History Lookup",        'NET', True),
    (61, "Multi-Port Banner Scan",    'NET', True),
    (62, "Network Topology",          'NET', True),
    (63, "Hash Generator",            'CRY', False),
    (64, "Hash Cracker",              'CRY', False),
    (65, "Base64 Tool",               'CRY', False),
    (66, "Caesar Cipher",             'CRY', False),
    (67, "Password Strength",         'CRY', False),
    (68, "Wordlist Generator",        'CRY', False),
    (69, "ROT13 Cipher",              'CRY', False),
    (70, "XOR Cipher",                'CRY', False),
    (71, "Morse Code",                'CRY', False),
    (72, "Binary Converter",          'CRY', False),
    (73, "Hex Converter",             'CRY', False),
    (74, "URL Encoder/Decoder",       'CRY', False),
    (75, "JWT Decoder",               'CRY', False),
    (76, "System Info",               'SYS', False),
    (77, "File Analyzer",             'SYS', False),
    (78, "WiFi Passwords (Win)",      'SYS', False),
    (79, "Process Viewer",            'SYS', False),
    (80, "Disk Usage",                'SYS', False),
    (81, "Environment Variables",     'SYS', False),
    (82, "Open Connections",          'SYS', False),
    (83, "File Hash Verifier",        'SYS', False),
    (84, "Directory Scanner",         'SYS', False),
    (85, "Log File Reader",           'SYS', False),
    (86, "IP Calculator (CIDR)",      'UTL', False),
    (87, "Random Password Generator", 'UTL', False),
    (88, "UUID Generator",            'UTL', False),
    (89, "Text Case Converter",       'UTL', False),
    (90, "Lorem Ipsum Generator",     'UTL', False),
    (91, "JSON Formatter",            'UTL', False),
    (92, "Unix Timestamp Converter",  'UTL', False),
    (93, "Color Code Converter",      'UTL', False),
    (94, "String Analyzer",           'UTL', False),
    (95, "Number Base Converter",     'UTL', False),
    (96, "Regex Tester",              'UTL', False),
    (97, "ASCII Art Generator",       'UTL', False),
    (98, "History Viewer",            'UTL', True),
    (99, "History Clear",             'UTL', True),
    (100,"Network Topology (ext)",    'NET', True),
    (101,"Plugin Manager",             'UTL', True),
    (102,"Check for Update",           'UTL', True),
    (103,"Favourites",                 'UTL', True),
    (104,"Module Search",              'UTL', True),
    (105,"XSS Scanner",                'WEB', True),
    (106,"Directory Bruteforcer",      'WEB', True),
    (107,"API Endpoint Fuzzer",        'WEB', True),
    (108,"Email Harvester",            'WEB', True),
    (109,"HTTP Smuggling Detector",    'WEB', True),
    (110,"Vigenère Cipher",            'CRY', True),
    (111,"Atbash Cipher",              'CRY', True),
    (112,"Hash Identifier",            'CRY', True),
    (113,"Advanced Password Gen",      'CRY', True),
    (114,"Encoding Detector",          'CRY', True),
]

ACTIONS = {
    1:  mod_ip_tracker,        2:  mod_dns_lookup,         3:  mod_port_scanner,
    4:  mod_mac_lookup,        5:  mod_local_network,       6:  mod_ping,
    7:  mod_subdomain_finder,  8:  mod_traceroute,          9:  mod_reverse_ip,
    10: mod_geoip,             11: mod_net_iface_stats,     12: mod_arp_scanner,
    13: mod_banner_grabber,    14: mod_http_methods,        15: mod_smtp_checker,
    16: mod_ftp_checker,       17: mod_ssh_checker,         18: mod_snmp_checker,
    19: mod_asn_lookup,        20: mod_ip_range_scanner,    21: mod_speed_test,
    22: mod_wifi_ssid_scanner, 23: mod_mdns_discovery,      24: mod_dns_zone_transfer,
    25: mod_open_redirect,     26: mod_cors_checker,        27: mod_cdn_detector,
    28: mod_ipv6_checker,      29: mod_port_knock,          30: mod_shodan_lookup,
    31: mod_admin_finder,      32: mod_cms_detector,        33: mod_waf_detector,
    34: mod_header_inspector,  35: mod_link_extractor,      36: mod_whois,
    37: mod_robots_checker,    38: mod_url_scanner,         39: mod_email_validator,
    40: mod_wayback,           41: mod_tech_stack,          42: mod_broken_links,
    43: mod_ssl_info,          44: mod_bulk_status,         45: mod_dork_generator,
    46: mod_http_fuzzer,       47: mod_js_extractor,        48: mod_form_extractor,
    49: mod_cookie_inspector,  50: mod_ip_reputation,       51: mod_path_traversal,
    52: mod_sql_error_detector,53: mod_subdomain_takeover,  54: mod_tls_checker,
    55: mod_whatweb,           56: mod_latency_map,         57: mod_cert_transparency,
    58: mod_cache_inspector,   59: mod_security_score,      60: mod_dns_history,
    61: mod_banner_scan,       62: mod_net_topology,
    63: mod_hash_generator,    64: mod_hash_cracker,        65: mod_base64,
    66: mod_caesar,            67: mod_password_checker,    68: mod_wordlist,
    69: mod_rot13,             70: mod_xor_cipher,          71: mod_morse,
    72: mod_binary,            73: mod_hex_converter,       74: mod_url_encoder,
    75: mod_jwt_decoder,
    76: mod_sys_info,          77: mod_file_analyzer,       78: mod_wifi_passwords,
    79: mod_processes,         80: mod_disk_usage,          81: mod_env_vars,
    82: mod_open_connections,  83: mod_file_hash_verifier,  84: mod_dir_scanner,
    85: mod_log_reader,
    86: mod_ip_calculator,     87: mod_random_password,     88: mod_uuid_generator,
    89: mod_text_case,         90: mod_lorem_ipsum,         91: mod_json_formatter,
    92: mod_timestamp,         93: mod_color_converter,     94: mod_string_analyzer,
    95: mod_number_base,       96: mod_regex_tester,        97: mod_ascii_art,
    98: mod_history_viewer,    99: mod_history_clear,       100: mod_net_topology,
    101: mod_plugin_list,
    102: mod_check_update,
    103: mod_favourites,
    104: mod_search,
    105: mod_xss_scanner,
    106: mod_directory_brute,
    107: mod_api_fuzzer,
    108: mod_email_harvester,
    109: mod_http_smuggling_detector,
    110: mod_vigenere_cipher,
    111: mod_atbash_cipher,
    112: mod_hash_identifier,
    113: mod_password_generator_advanced,
    114: mod_encoding_detector,
}
...
def show_help():
    ...
    w = min(term_width(), 90)
    hline('═', LCYN, w)
    cprint(f"{BOLD}{LCYN}◈  KOOLTI-TOOL v8.0  —  HELP  ◈{RST}")
    hline('═', LCYN, w)
    print(f"""
  {BOLD}Navigation:{RST}
    {LYLW}[nn]{RST}    Enter module number and press Enter
    {LYLW}[q/0]{RST}   Quit
    {LYLW}[h]{RST}     This help page

  {BOLD}Module categories:{RST}
    {tag_net()}  Network tools (30+ modules)
    {tag_web()}  Web & OSINT (25+ modules)
    {tag_cry()}  Crypto (13 modules)
    {tag_sys()}  System (10 modules)
    {tag_utl()}  Utilities (12+ modules)

  {BOLD}History:{RST}
    All module results are saved to:
    {LBLU}{HISTORY_DIR}{RST}
    {DIM}Password-related modules (47, 64, 67, 68, 87) are excluded.{RST}
    Use module {LYLW}[98]{RST} to browse history, {LYLW}[99]{RST} to clear it.

  {BOLD}Legal notice:{RST}
    {LRED}Use only on systems you own or have explicit permission{RST}
    {LRED}to test. Unauthorized scanning may be illegal.{RST}

  {BOLD}Requirements:{RST}
    {DIM}pip install requests psutil rich{RST}
    {DIM}GPU cracking: pip install cupy-cuda12x  OR  winget install hashcat{RST}
""")
    hline('─', DIM, w)
    pause()
...
def main():
    ...
    while True:
        ...
        draw_menu()
        print()
        cmd = input_with_history(f"  {LGRN}{BOLD}❯{RST}  {DIM}(h=help  u=update  /=search  fav=favourites){RST}\n  {LGRN}{BOLD}❯{RST} ").lower()
        ...
        if cmd in ('/', 'search', 'find'):
            ...
            pause()
            continue
        if cmd in ('fav', 'favourites', 'favorites', 'f'):
            mod_favourites()
            pause()
            continue
        try:
            ...
            continue
        if cmd_int in ACTIONS:
            try:
                ACTIONS[cmd_int]()
            except KeyboardInterrupt:
                print(f"\n\n  {LYLW}Interrupted by user{RST}")
            except Exception as e:
                print(f"\n  {LRED}Module {cmd_int} error: {e}{RST}")
            pause()
        elif cmd_int in _loaded_plugins:
            p = _loaded_plugins[cmd_int]
            try:
                mod_header(p.get('name','Plugin'), p.get('description',''), '🧩', LCYN)
                p['run']()
                history_log(cmd_int, p.get('name','plugin'), {'plugin': p.get('name')})
            except KeyboardInterrupt:
                print(f"\n\n  {LYLW}Interrupted by user{RST}")
            except Exception as e:
            ...
            print(f"  {LYLW}No module #{cmd_int}{RST}")
            time.sleep(0.8)
